...
function App() {
  ...
  useEffect(() => {
    ...
    if (isRed === true) colorArr.push("red");
    if (isOrange === true) colorArr.push("orange");
    if (isBrown === true) colorArr.push("brown");
    if (isLightBrown === true) colorArr.push("light-brown");
    if (isYellow === true) colorArr.push("yellow");
